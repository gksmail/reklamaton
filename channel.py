...
def get_channel(client, channel_entity):
   ...
   # print("Channel Description:", channel_description)
    ...
    for message in client.iter_messages(channel, limit=15):
...
with TelegramClient('session_name', api_id, api_hash) as client:
   ...
   all_data = get_channel(client, channal_name)
   print('-----------------------------------')
   print('-------------FINISH----------------')
   #print('channel_data', all_data)
   with open(channal_name + '.json', 'w') as fp:
